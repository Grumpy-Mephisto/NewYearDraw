...
public class Snowman {
        ...
        public void draw(Graphics2D g2d, int width, int height) {
                ...
                // Middle Oval
                circle.drawCircle(g2d, centerX, (int) middleCenterY + 25,
                                (int) (middleDiameter / 2), true);

                // Head Oval
                circle.drawCircle(g2d, centerX, (int) headCenterY + 30, (int) (headDiameter / 2),
                                true);
                ...
                circle.drawCircle(g2d, (int) ((centerX) - (headDiameter / 4)),
                                ((int) (headCenterY - (headDiameter / 4))) + 30,
                                (int) eyeDiameter / 2, true);
